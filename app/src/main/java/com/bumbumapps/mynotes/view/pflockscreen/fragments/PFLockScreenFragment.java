package com.bumbumapps.mynotes.view.pflockscreen.fragments;
...
import com.bumbumapps.mynotes.view.pflockscreen.views.PFCodeView;
...
public class PFLockScreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (Setting.Dark_Mode){
            view.findViewById(R.id.lockScreenpf).setBackgroundResource(R.drawable.black_pf_background);
        }
