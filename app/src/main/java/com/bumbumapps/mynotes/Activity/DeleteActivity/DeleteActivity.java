package com.bumbumapps.mynotes.Activity.DeleteActivity;
...
import com.bumbumapps.mynotes.Activity.Note.RestoreNoteActivity;
...
public class DeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Setting.Dark_Mode) {
            ...
            findViewById(R.id.linear).setBackgroundColor(ContextCompat.getColor(getApplicationContext(),R.color.background_Night));
            setTheme(R.style.AppTheme2);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case android.R.id.home:
                ...
                overridePendingTransition(0, 0);
                startActivity(new Intent(DeleteActivity.this, SettingActivity.class));
                finish();
                break;
