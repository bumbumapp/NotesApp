package com.bumbumapps.mynotes.Activity.Setting;
...
import com.bumbumapps.mynotes.view.SwitchButton.SwitchButton;
...
import com.bumbumapps.mynotes.Activity.LockScreen.LockRemoveActivity;
import com.bumbumapps.mynotes.Activity.LockScreen.LockScreenActivity;
import com.bumbumapps.mynotes.Activity.MainActivity;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private LinearLayout about, lockScreen, ll_clearcache, recyclebin,settinglinear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclebin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SettingActivity.this, DeleteActivity.class));
                finish();
            }
        });
